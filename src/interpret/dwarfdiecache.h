...
/**
 * @return the file name and line number for the instruction at the given @p offset in @p cuDie
 ...
 */
DwarfFileAndLine findFileAndLine(Dwarf_Die* cuDie, Dwarf_Addr offset);
